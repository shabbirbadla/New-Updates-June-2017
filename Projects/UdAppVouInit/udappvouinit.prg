...
If Inlist(.pcvtype,'IP','VI','ST','OS','DP','DR','BI','FP','FR','VR','JV') Or Inlist(.pcvtype,'J2','J3','B3','B4','EI','PP','TH','RH','FH','EH','SI','PL','GA','J5','GB')  && Added  by Shrikant S. on 26/04/2017 for GST
...
If Inlist(.pcvtype,'J5','GA','GB')
	...
	.CmdServiceTax.Caption="GST Rev. Details"
	.CmdServiceTax.ToolTipText 		="GST Reversal Details"
